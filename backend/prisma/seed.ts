...
async function main() {
  ...
  const stockHistories = [
    ...
    },
    {
      ...
      trend: 0,
      time: new Date('2022-12-03T10:00:00'),
      stock: { connect: { name: 'STOCK3 NAME' } },
    },
    {
      split: 3,
      open: 110.0,
      ...
      trend: 0,
      time: new Date('2022-12-03T10:00:00'),
      stock: { connect: { name: 'STOCK4 NAME' } },
    },
    {
      split: 3,
      open: 110.0,
      ...
      trend: 0,
      time: new Date('2022-12-03T10:00:00'),
      stock: { connect: { name: 'STOCK5 NAME' } },
    },
    {
      split: 3,
      open: 110.0,
      ...
      trend: 0,
      time: new Date('2022-12-03T10:00:00'),
      stock: { connect: { name: 'STOCK6 NAME' } },
    },
    {
      split: 3,
      open: 110.0,
      ...
      trend: 0,
      time: new Date('2022-12-03T10:00:00'),
      stock: { connect: { name: 'STOCK7 NAME' } },
    },
    {
      split: 3,
      open: 110.0,
      ...
      trend: 0,
      time: new Date('2022-12-03T10:00:00'),
      stock: { connect: { name: 'STOCK8 NAME' } },
    },
    {
      split: 3,
      open: 110.0,
      ...
      trend: 0,
      time: new Date('2022-12-03T10:00:00'),
      stock: { connect: { name: 'STOCK9 NAME' } },
    },
    {
      split: 3,
      open: 110.0,
      ...
      trend: 0,
      time: new Date('2022-12-03T10:00:00'),
      stock: { connect: { name: 'STOCK10 NAME' } },
    },
    {
      split: 3,
      open: 110.0,
      ...
      trend: 0,
      time: new Date('2022-12-03T10:00:00'),
      stock: { connect: { name: 'STOCK11 NAME' } },
    },
    {
      split: 3,
      open: 110.0,
      ...
      trend: 0,
      time: new Date('2022-12-03T10:00:00'),
      stock: { connect: { name: 'STOCK12 NAME' } },
    },
    {
      split: 3,
      open: 110.0,
      ...
      trend: 0,
      time: new Date('2022-12-03T10:00:00'),
      stock: { connect: { name: 'STOCK13 NAME' } },
    },
    {
      split: 3,
      open: 110.0,
      ...
      trend: 0,
      time: new Date('2022-12-03T10:00:00'),
      stock: { connect: { name: 'STOCK14 NAME' } },
    },
    {
      split: 3,
      open: 110.0,
      ...
      trend: 0,
      time: new Date('2022-12-03T10:00:00'),
      stock: { connect: { name: 'STOCK15 NAME' } },
    },
    {
      split: 3,
      open: 110.0,
      ...
      trend: 0,
      time: new Date('2022-12-03T10:00:00'),
      stock: { connect: { name: 'STOCK16 NAME' } },
    },
    {
      split: 3,
      open: 110.0,
      ...
      trend: 0,
      time: new Date('2022-12-03T10:00:00'),
      stock: { connect: { name: 'STOCK17 NAME' } },
    },
    {
      split: 3,
      open: 110.0,
      ...
      trend: 0,
      time: new Date('2022-12-03T10:00:00'),
      stock: { connect: { name: 'STOCK18 NAME' } },
    },
    {
      split: 3,
      open: 110.0,
      ...
      trend: 0,
      time: new Date('2022-12-03T10:00:00'),
      stock: { connect: { name: 'STOCK19 NAME' } },
    },
    {
      split: 3,
      open: 110.0,
      ...
      trend: 0,
      time: new Date('2022-12-03T10:00:00'),
      stock: { connect: { name: 'STOCK20 NAME' } },
    },
  ]; */

  /* const stockHistories: Prisma.StockHistoryCreateInput[] = [];
  for (let i = 0; i <= 365 * 20; i++) {
    const date = new Date();
    date.setDate(date.getDate() - i);

    for (let i = 1; i <= 20; i++) {
      stockHistories.push({
        // first value for each month for each stock will have a split of 3
        split: date.getDate() === 1 ? 3 : 1,
        open: 110.0,
        close: 110.0,
        high: 110.0,
        low: 110.0,
        time: date,
        trend: 0,
        stock: { connect: { name: `STOCK${i} NAME` } },
      });
    }
  }
